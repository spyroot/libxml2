...
ACLOCAL = ${SHELL} /root/rpm/libxml2-2.9.9/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /root/rpm/libxml2-2.9.9/missing autoconf
AUTOHEADER = ${SHELL} /root/rpm/libxml2-2.9.9/missing autoheader
AUTOMAKE = ${SHELL} /root/rpm/libxml2-2.9.9/missing automake-1.13
AWK = gawk
...
CFLAGS = -m64 -Wno-deprecated-declarations
CPP = gcc -E
...
LZMA_LIBS = -llzma  
MAINT = 
MAKEINFO = ${SHELL} /root/rpm/libxml2-2.9.9/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MODULE_EXTENSION = .so
...
PYTHON_INCLUDES = /usr/local/include/python3.11
PYTHON_LIBS = -L/usr/local/lib/python3.11/config-3.11-x86_64-linux-gnu -L/usr/local/lib  -lpthread -ldl  -lutil -lm 
PYTHON_SITE_PACKAGES = /usr/local
PYTHON_SUBDIR = python
PYTHON_TESTS =  RelaxNGPythonTests SchemasPythonTests
PYTHON_VERSION = 3.11
RANLIB = ranlib
RDL_LIBS = -lreadline -lhistory -lncurses
READER_TEST = Readertests
RELDATE = Wed Dec 21 2022
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/sh
STATIC_BINARIES = 
...
XML_LIBDIR = -L${libdir}
XML_LIBS = -lxml2 -L/usr/ib64 -lz   -llzma     -liconv  -lm -lpython3.11
XML_LIBTOOLLIBS = libxml2.la
XPATH_OBJ = xpath.o
XPTR_OBJ = xpointer.o
XSLTPROC = /bin/xsltproc
Z_CFLAGS =  
Z_LIBS = -L/usr/ib64 -lz  
abs_builddir = /root/rpm/libxml2-2.9.9
abs_srcdir = /root/rpm/libxml2-2.9.9
abs_top_builddir = /root/rpm/libxml2-2.9.9
abs_top_srcdir = /root/rpm/libxml2-2.9.9
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/rpm/libxml2-2.9.9/install-sh
libdir = /usr/lib64
